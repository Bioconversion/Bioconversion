# Bioconversion Üretim Prosesi

## 1. Atık Pamuk Sapının Hazırlanması

Atık pamuk sapları öğütülerek **50 mm** boyutuna getirilir. Öğütülen pamuk sapları yıkandıktan sonra **50 °C'de** kurutulur.

## 2. Selüloz Üretimi

Kurutulan pamuk sapları;

- %4 borik asit
- %16 sodyum hidroksit (NaOH)
- %3 sodyum karbonat (Na₂CO₃)

içeren çözelti ile **1/5 katı/sıvı oranında** reaktöre alınır.

Pişirme işlemi **160 °C'de 2 saat** gerçekleştirilir.

Pişirme işleminin ardından **siyah likör ve selüloz fraksiyonu ayrılır**.
...
- %2 sodyum hidroksit (NaOH)
- %10 hidrojen peroksit (H₂O₂)
- %0,5 sodyum silikat
- %0,05 EDTA

eklenir.

Karışım, ısıtıcılı manyetik karıştırıcı üzerinde **75 °C'de 1 saat** boyunca ağartma işlemine tabi tutulur.
...
Elde edilen mikrokristalin selülozun asetilasyonu amacıyla;

- %7 asetik asit
- %20 asetik anhidrit
- %1 sülfürik asit

içeren karışıma mikrokristalin selüloz eklenir.

Asetilasyon işlemi, ısıtıcılı manyetik karıştırıcı üzerinde **45 °C'de 1 saat** gerçekleştirilir.

Ardından karışıma **%1 su ve %7 asetik asit** eklenerek **12 saat hidroliz** gerçekleştirilir.
